...
export const themes: Record<ThemeName, Theme> = {
  'pastel-classic': {
    ...
    gradientCSS: 'linear-gradient(to bottom right, #FFE4E9, #E4F1FF, #FFF9E4)',
  },
  'candy-ice-cream': {
    ...
    gradientCSS: 'linear-gradient(to bottom right, #B8E6D5, #E6D5F5, #FFB5A7)',
  },
  'rainbow-nursery': {
  ...
  'ocean-baby': {
    ...
    gradientCSS: 'linear-gradient(to bottom right, #A8E6E3, #FFB5A7, #F5E6D3)',
  },
  'woodland-forest': {
    ...
    gradientCSS: 'linear-gradient(to bottom right, #C8D5B9, #FAF3E0, #E8B4A0)',
  },
  'dreamy-clouds': {
    name: 'dreamy-clouds',
    ...
    gradientCSS: 'linear-gradient(to bottom right, #BFDBF7, #F8F9FA, #FFE89C)',
  },
  'bubblegum-pop': {
    name: 'bubblegum-pop',
    ...
    gradientCSS: 'linear-gradient(to bottom right, #FFB6D9, #D4B5F0, #FFD19C)',
  },
}
